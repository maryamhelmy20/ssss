...
const BannerSection = ({
  ...
  return (
    <BannerWrapper id="banner_section"   dir={locale === "ar" ? "rtl" : "ltr"}>
      ...
      <Container>
        <Box {...row}>
          <Box {...contentWrapper}>
            <DiscountWrapper>
              <DiscountLabel>
                <Text {...discountAmount} content={banner.news.offer} />
                <Text
                  {...discountText}
                  content={banner.news.freeOffer}
                />
              </DiscountLabel>
            </DiscountWrapper>
            <Heading {...title} content={banner.news.title} />

            <Text {...description} content={banner.news.p} />
            <Box {...buttonWrapper} >
              <Link href="#">
                <Button {...fillButton} title={banner.news.freeTrail} />
              </Link>
              <Link href="#">
                <Button
                  {...button}
                  title={banner.news.discover}
