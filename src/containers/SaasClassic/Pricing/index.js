...
import {
  ...
  MONTHLY_PRICING_TABLE_AR,
  YEARLY_PRICING_TABLE,
  YEARLY_PRICING_TABLE_AR,
...
const PricingSection = ({
  ...
  const { locale } = router;
  const { pricingSection } = locale === "en" ? en : ar;
  ...
  return (
    <Box {...sectionWrapper} id="pricing_section">
      <Container>
        <Box {...secTitleWrapper} dir={locale === "ar" ? "rtl" : "ltr"}>
          <Text {...secText} content={pricingSection.headText} />
          <Heading {...secHeading} content={pricingSection.heading} />
          <PricingButtonWrapper>
            <Button
              title={pricingSection.mPricing.title}
            ...
            />
            <Button
              title={pricingSection.yPricing.title}
            ...
            />
            <Link href="#">+ {pricingSection.cPricing.title}</Link>
          </PricingButtonWrapper>
        </Box>
        <PricingTableWrapper>
          <GlideCarousel
