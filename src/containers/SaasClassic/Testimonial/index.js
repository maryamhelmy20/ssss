...
import { TESTIMONIALS, TESTIMONIALS_AR } from "common/data/SaasClassic";
...
const TestimonialSection = ({
  ...
  const { locale } = router;
  const { testimonialSection } = locale === "en" ? en : ar;
  const t = locale === "ar" ? TESTIMONIALS_AR : TESTIMONIALS;
  ...
  return (
    <Box {...sectionWrapper} as="section" id="testimonial_section">
      <Container>
        <Box {...secTitleWrapper}>
          <Text {...secText} content={testimonialSection.headText} />
          <Heading {...secHeading} content={testimonialSection.heading} />
        </Box>
        <TestimonialSlideWrapper>
          <GlideCarousel
