...
const SaasClassic = () => {
    ...
    return ( <
        ...
        content = "#12805D" / > { /* Load google fonts */ } <
        link href = "https://fonts.googleapis.com/css?family=Roboto:300,400,400i,500,500i,700,900|Open+Sans:400,400i,600,700"
        rel = "stylesheet" /
        >
        <
        /Head>
        ...
        BannerSection / >
        <
        ServiceSection / > { /* <UpdateScreen /> */ } <
        FeatureSection / >
        <
        PartnerSection / >
        <
        PricingSection / > { /* rtl problem */ } <
        TestimonialSection / > { /* <TrialSection /> */ } <
        Newsletter / >
        <
        Footer / >
        <
